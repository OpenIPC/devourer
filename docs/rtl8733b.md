...
over `[-64, +127]`, the int8 per-rate delta field's range and the same
clamped-only-at-the-hardware-rail answer Jaguar1 (±126) and Jaguar3 (±127)
give. Offset 0 is `kSafeTssiTargetQdbm8733b` (16 dBm), a first-light clip
sitting at or below this part's factory targets (18–20 dBm at 2.4 GHz,
16–19 at 5 GHz); −64 qdB puts the target at 0 qdBm, where the delta field
bottoms out at the same moment.
