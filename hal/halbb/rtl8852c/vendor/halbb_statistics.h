...
struct bb_stat_c2h_rpt {
	...
	u16	cnt_ofdm_cca;
	u16	cnt_cck_cca;
	u16	cnt_cck_spoofing;
	u16	cnt_ofdm_spoofing;
	u16	pop_cnt;
	u16	cnt_ampdu_miss;
	u16	cnt_ampdu_crc_error;
	u16	cnt_ampdu_crc_ok;
	u16	cnt_cck_crc32_error;
	u16	cnt_cck_crc32_ok;
	u16	cnt_ofdm_crc32_error;
	u16	cnt_ofdm_crc32_ok;
	u16	cnt_ht_crc32_error;
	u16	cnt_ht_crc32_ok;
	u16	cnt_vht_crc32_error;
	u16	cnt_vht_crc32_ok;
	u16	cnt_he_crc32_ok;
	u16	cnt_he_crc32_error;
	u16	cnt_eht_crc32_ok;
	u16	cnt_eht_crc32_error;
	u16	cnt_ofdm2_crc32_error;
	u16	cnt_ofdm2_crc32_ok;
	u16	cnt_ht2_crc32_error;
	u16	cnt_ht2_crc32_ok;
	u16	cnt_vht2_crc32_error;
	u16	cnt_vht2_crc32_ok;
	u16	cnt_he2_crc32_error;
	u16	cnt_he2_crc32_ok;
	u16	cnt_eht2_crc32_ok;
	u16	cnt_eht2_crc32_error;
	u16	cnt_ofdm3_crc32_error;
	u16	cnt_ofdm3_crc32_ok;
	u16	cnt_cck_fail;
	u16	cnt_ofdm_fail;
	u16	sfd_gg_cnt;
	u16	sig_gg_cnt;
	u16	cnt_cck_crc_16;
	u16	cnt_lsig_brk_s_th;
	u16	cnt_lsig_brk_l_th;
	u16	cnt_parity_fail;
	u16	cnt_rate_illegal;
	u16	cnt_sb_search_fail;
	u16	cnt_crc8_fail_s_th;
	u16	cnt_crc8_fail_l_th;
	u16	cnt_mcs_fail;
	u16	cnt_crc8_fail_vhta;
	u16	cnt_mcs_fail_vht;
};
#endif
